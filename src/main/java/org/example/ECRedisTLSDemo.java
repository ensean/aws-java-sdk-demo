...
public class ECRedisTLSDemo {
     ...
     */
    public ECRedisTLSDemo() throws IOException {
        initialize();
    }
...
//        FileInputStream fis = new FileInputStream(new File("config.properties"));
        ...
        redisAuth = properties.getProperty("REDIS_CLUSTER_AUTH");
...
//        fis.close();
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        ECRedisTLSDemo ECRedisTLSDemo = new ECRedisTLSDemo();
        ECRedisTLSDemo.upsertCacheEntries("Name", "Value", false);
        ECRedisTLSDemo.getRandomCacheValue("Name");
        ECRedisTLSDemo.deleteRandomCacheEntry("Name");
        ECRedisTLSDemo.shutdown();
    }
}
